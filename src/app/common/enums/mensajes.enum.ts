...
export enum mensajeInicioSesion {
  inicioSesionExitoso = 'Inicio de sesión exitoso',
  inicioSesionFallido = 'Inicio de sesión fallido',
  inicioSesionCargando = 'Iniciando sesión...',
}

export enum mensajeCrearCuenta {
  crearCuentaExitoso = 'Cuenta creada con éxito',
  crearCuentaFallido = 'Error al crear la cuenta',
  crearCuentaCargando = 'Creando cuenta...',
  crearCuentaDatosVacios = 'Por favor ingrese todos los datos',
}
